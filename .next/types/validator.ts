...
// Validate ../../pages/api/download-schedule.ts
{
  const handler = {} as typeof import("../../pages/api/download-schedule.js")
  handler satisfies ApiRouteConfig
}

// Validate ../../pages/api/generate-schedule.ts
{
  const handler = {} as typeof import("../../pages/api/generate-schedule.js")
  handler satisfies ApiRouteConfig
}
